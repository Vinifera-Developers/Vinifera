...
function(GetGitState _working_dir)
    ...
    list(GET ENV{GIT_COMMIT_DATE} 0 ${TEMP_DATE_VAR})
    list(GET ENV{GIT_COMMIT_TIME} 1 ${TEMP_DATE_VAR})
    list(GET ENV{GIT_COMMIT_TZONE} 2 ${TEMP_DATE_VAR})
	#set(ENV{GIT_COMMIT_DATE} ${TEMP_DATE})
	#set(ENV{GIT_COMMIT_TIME} ${TEMP_TIME})
	#set(ENV{GIT_COMMIT_TZONE} ${TEMP_TZONE})
	#message($ENV{GIT_COMMIT_DATE})
	#message($ENV{GIT_COMMIT_TIME})
	#message($ENV{GIT_COMMIT_TZONE})
