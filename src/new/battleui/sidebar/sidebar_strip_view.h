...
/*******************************************************************************
 *  @brief  Shared scrollable sidebar column view. Displays one BuildCategory
 *          worth of items with scroll buttons, select buttons, and hover
 *          tracking. Used by both Classic (×2) and Tabbed (×4) views.
 *
