...
DEFINE_HOOK(0x005FB2CE, _SmudgeTypeClass_Constructor_Patch, 0x5)
{
     ...
     */
    Extension::Make<SmudgeTypeClassExtension>(this_ptr);
 ...
 *  @author: CCHyper
 */
DEFINE_HOOK(0x005FC028, _SmudgeTypeClass_Scalar_Destructor_Patch, 0x6)
{
