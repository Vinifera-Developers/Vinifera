 ...
 *  @author: CCHyper
 */
EXPORT_FUNC(_WarheadTypeClass_Constructor_Patch)
{
 ...
 *  @author: CCHyper
 */
EXPORT_FUNC(_WarheadTypeClass_Scalar_Destructor_Patch)
{
...
declhook(0x0066EEF4, _WarheadTypeClass_Constructor_Patch, 0x7);
declhook(0x0066FA98, _WarheadTypeClass_Scalar_Destructor_Patch, 0x6);
