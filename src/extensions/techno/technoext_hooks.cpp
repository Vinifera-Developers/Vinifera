 ...
 *  @author: CCHyper
 */
const WeaponInfoStruct * TechnoClassFake::_Get_Weapon(WeaponSlotType weapon) const
{
...
void TechnoClassExtension_Hooks()
{
    ...
    Change_Virtual_Address(0x006CB104, Get_Func_Address(&TechnoClassFake::_Get_Weapon));
    Change_Virtual_Address(0x006D06E4, Get_Func_Address(&TechnoClassFake::_Get_Weapon));
    Change_Virtual_Address(0x006D2428, Get_Func_Address(&TechnoClassFake::_Get_Weapon));
    Change_Virtual_Address(0x006D7F64, Get_Func_Address(&TechnoClassFake::_Get_Weapon));
    Change_Virtual_Address(0x006D8E78, Get_Func_Address(&TechnoClassFake::_Get_Weapon));
}
