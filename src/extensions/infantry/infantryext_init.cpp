 ...
 *  @author: CCHyper
 */
EXPORT_FUNC(_InfantryClass_Constructor_Patch)
{
 ...
 *  @author: CCHyper
 */
EXPORT_FUNC(_InfantryClass_Destructor_Patch)
{
...
declhook(0x004D21E1, _InfantryClass_Constructor_Patch, 0x5);
declhook(0x004D22E1, _InfantryClass_Destructor_Patch, 0x5);
