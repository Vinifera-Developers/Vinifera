...
public:
    ...
    bool Aircraft_Do_MISSION_MOVE_Apply_QMove();
};
 ...
 *  @author: JoyfulShush
 */
bool AircraftClassExt::Aircraft_Do_MISSION_MOVE_Apply_QMove()
{
    if (NavQueue.Count() <= 0) {
        return false;
    }
...
{    
    ...
    bool qmove_applied = this_ptr->Aircraft_Do_MISSION_MOVE_Apply_QMove();
