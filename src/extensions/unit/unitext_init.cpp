 ...
 *  @author: CCHyper
 */
EXPORT_FUNC(_UnitClass_Constructor_Patch)
{
 ...
 *  @author: CCHyper
 */
EXPORT_FUNC(_UnitClass_Destructor_Patch)
{
...
declhook(0x0064D7B4, _UnitClass_Constructor_Patch, 0x5);
declhook(0x0064D8AE, _UnitClass_Destructor_Patch, 0x6);
