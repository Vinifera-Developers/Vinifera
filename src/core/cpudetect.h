...
class CPUDetectClass
{
    ...
    public:
        ...
        /**
         *  Speed is calculated once during static initialisation, depending on
         *  CPU model speed state of CPU could affect this.
         */
        ...
        static uint32_t Get_OS_Version_Number_Major() { return OSVersionNumberMajor; }
        static uint32_t Get_OS_Version_Number_Minor() { return OSVersionNumberMinor; }
        static uint32_t Get_OS_Version_Build_Number() { return OSVersionBuildNumber; }
        static uint32_t Get_OS_Version_Platform_Id() { return OSVersionPlatformId; }
